    ...
    return (
        <CallProvider>
            <Stack initialRouteName="(tabs)" screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name="subscriptionScreenHome" options={{ presentation: 'modal' }} />
                <Stack.Screen name="employeeProfile" options={{ presentation: 'fullScreenModal' }} />
                <Stack.Screen name="rechargeScreen" options={{ presentation: 'modal' }} />
            </Stack>
            <PromoPopup />
        </CallProvider>
    )
